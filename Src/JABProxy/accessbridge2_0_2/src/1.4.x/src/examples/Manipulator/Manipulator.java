...
/*
 * @(#)Manipulator.java	1.12 02/01/17
 */
...
/**
 * <P>Manipulator is an example assistive technology that uses EventQueueMonitor,
 *
 ...
 * @author      Peter Korn
 */
public class Manipulator implements KeyListener, ActionListener, MenuListener,
        GUIInitializedListener {
    
    JMenu activeMenu = null; 
    ManipulatorPanel aaPanel;
    ...
    public void createGUI() {
        Frame frame = new Frame("Manipulator");
        ...
        // Add ManipulatorPanel
        //
	aaPanel = new ManipulatorPanel();
        frame.add("Center", aaPanel);
	...
	if (a == null) {
		...
		aaPanel.updateInfo(ac, containerPoint);
	    } else {
		aaPanel.updateInfo(null,null);
	    }
        } else {
	    aaPanel.updateInfo(null, null);
	}
