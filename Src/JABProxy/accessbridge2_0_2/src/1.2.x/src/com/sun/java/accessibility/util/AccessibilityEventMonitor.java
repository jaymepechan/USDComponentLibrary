...
/*
 * @(#)AccessibilityEventMonitor.java	1.12 02/01/17
 */
 ...
 *
 * @version     1.12 01/17/02 16:06:45
 * @author      Peter Korn
 */
...
public class AccessibilityEventMonitor {
	...
	public void propertyChange(PropertyChangeEvent e) {
		...
		if ((oldValue == null) ^ (newValue == null)) { // one null, not both
		    if (oldValue != null && oldValue instanceof AccessibleContext) {
			// this Accessible is a child that's going away
			removeListeners((AccessibleContext) oldValue);
		    } else if (newValue != null && newValue instanceof AccessibleContext) {
