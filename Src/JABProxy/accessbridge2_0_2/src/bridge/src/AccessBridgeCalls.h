...
/*
 * @(#)AccessBridgeCalls.h	1.26 05/08/22
 */
...
#define null NULL
    ...
    typedef BOOL (*IsSameObjectFP) (long vmID, jobject obj1, jobject obj2);
    ...
    typedef jobject (*GetAccessibleSelectionFromContextFP) (long vmID, AccessibleSelection as, int i);
    ...
    HWND GetHWNDFromAccessibleContext(long vmID, jobject accesibleContext);
