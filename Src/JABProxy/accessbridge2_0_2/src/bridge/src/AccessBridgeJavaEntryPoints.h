...
/*
 * @(#)AccessBridgeJavaEntryPoints.h	1.27 05/03/21
 */
...
public:
    ...
    BOOL setTextContents(const AccessibleContext accessibleContext, const wchar_t *text);
    AccessibleContext getParentWithRole (const AccessibleContext accessibleContext, const wchar_t *role);
    AccessibleContext getTopLevelObject (const AccessibleContext accessibleContext);
    AccessibleContext getParentWithRoleElseRoot (const AccessibleContext accessibleContext, const wchar_t *role);
    jint getObjectDepth (const AccessibleContext accessibleContext);
    AccessibleContext getActiveDescendent (const AccessibleContext accessibleContext);
    ...
    BOOL getAccessibleHypertextExt(const AccessibleContext accessibleContext,
                                   const jint nStartIndex,
                                   /* OUT */ AccessibleHypertextInfo *hypertext);
    jint getAccessibleHyperlinkCount(const AccessibleContext accessibleContext);
    jint getAccessibleHypertextLinkIndex(const AccessibleContext accessibleContext,
                                         const jint nIndex);
    BOOL getAccessibleHyperlink(const AccessibleContext accessibleContext,
                                const jint nIndex, 
     ...
     */
    BOOL getVirtualAccessibleName(AccessibleContext accessibleContext, wchar_t *name, int len);
     ...
     */
    BOOL requestFocus(AccessibleContext accessibleContext);
     ...
     */
    BOOL selectTextRange(AccessibleContext accessibleContext, int startIndex, int endIndex);
     ...
     */
    BOOL getTextAttributesInRange(AccessibleContext accessibleContext, int startIndex, int endIndex,
     ...
     */
    int getVisibleChildrenCount(const AccessibleContext accessibleContext);
     ...
     * Bug ID 4944762- getVisibleChildren for list-like components needed
     */
    BOOL getVisibleChildren(const AccessibleContext accessibleContext, const int startIndex, 
     ...
     */
    BOOL setCaretPosition(AccessibleContext accessibleContext, int position);
