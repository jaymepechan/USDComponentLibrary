...
/*
 * @(#)AccessBridgePackages.h	1.48 05/12/08
 */
...
extern "C" {
     ...
     */
#define ACCESS_BRIDGE_VERSION  L"AccessBridge 2.0"
...
#define SHORT_STRING_SIZE   256
    ...
    typedef jobject Java_Object;
    typedef jobject PropertyChangeEvent;
    typedef jobject FocusEvent;
    typedef jobject CaretEvent;
    typedef jobject MouseEvent;
    typedef jobject MenuEvent;
    typedef jobject AccessibleTable;
    typedef jobject AccessibleHyperlink;
    typedef jobject AccessibleHypertext;
...
*/
	...
	jint y;
	long vmID;
	jobject AccessibleContext;		// look within this AC
	jobject rAccessibleContext;
...
#define MAX_TABLE_SELECTIONS 64
	...
	jobject caption;	// AccesibleContext
        jobject summary;	// AccessibleContext
	jint rowCount;
	jint columnCount;
	jobject accessibleContext;
...
#define MAX_RELATIONS 5
	...
	jint targetCount;
	jobject targets[MAX_RELATION_TARGETS];  // AccessibleContexts
...
#define MAX_HYPERLINKS		64	// maximum number of hyperlinks returned
	...
	jobject accessibleHyperlink; // AccessibleHyperlink object
	...
	jobject accessibleHypertext; // AccessibleHypertext object
	...
	jobject accessibleContext; // AccessibleContext with hypertext
	...
	long vmID;              // the virtual machine ID
	jobject accessibleContext; // AccessibleContext containing the link
	jobject accessibleHyperlink; // the link to activate
	...
	long vmID;              // the virtual machine ID
	jobject accessibleContext;	// AccessibleContext containing AccessibleHypertext
	...
	long vmID;		// the virtual machine ID
	jobject hypertext;	// AccessibleHypertext
...
#define ACCESSIBLE_BUTTON3_KEYSTROKE		128
	...
	long vmID;					// the virtual machine id
	jobject accessibleContext;			// the component
...
#define MAX_ACTIONS_TO_DO 32
	...
	long vmID;						// the virtual machine ID
	jobject accessibleContext;		// component to do the action
...
*/
	...
	long vmID;
	jobject accessibleContext;		// the text field
...
*/
	...
	jobject Event;
	jobject AccessibleContextSource;
	jobject oldChildAccessibleContext;
	jobject newChildAccessibleContext;
	...
	jobject Event;
	jobject AccessibleContextSource;
	jobject oldActiveDescendentAccessibleContext;
	jobject newActiveDescendentAccessibleContext;
...
#define MAX_VISIBLE_CHILDREN 256
	...
	long vmID;              // the virtual machine ID
	jobject accessibleContext; // AccessibleContext of parent component
