...
#define null NULL
     ...
     */
	__declspec(dllexport) BOOL initializeAccessBridge();
	__declspec(dllexport) BOOL shutdownAccessBridge();

    /**
     * Window routines
     */
	__declspec(dllexport) BOOL isJavaWindow(HWND window);

    // Returns the virtual machine ID and AccessibleContext for a top-level window
	__declspec(dllexport) BOOL getAccessibleContextFromHWND(HWND target, long *vmID, AccessibleContext *ac);

    // Returns the HWND from the AccessibleContext of a top-level window
	__declspec(dllexport) HWND getHWNDFromAccessibleContext(long vmID, AccessibleContext ac);


    /**
     * Event handling routines
     */
	__declspec(dllexport) void setJavaShutdown(AccessBridge_JavaShutdownFP fp);
	__declspec(dllexport) void setFocusGained(AccessBridge_FocusGainedFP fp);
	__declspec(dllexport) void setFocusLost(AccessBridge_FocusLostFP fp);

	__declspec(dllexport) void setCaretUpdate(AccessBridge_CaretUpdateFP fp);

	__declspec(dllexport) void setMouseClicked(AccessBridge_MouseClickedFP fp);
	__declspec(dllexport) void setMouseEntered(AccessBridge_MouseEnteredFP fp);
	__declspec(dllexport) void setMouseExited(AccessBridge_MouseExitedFP fp);
	__declspec(dllexport) void setMousePressed(AccessBridge_MousePressedFP fp);
	__declspec(dllexport) void setMouseReleased(AccessBridge_MouseReleasedFP fp);

	__declspec(dllexport) void setMenuCanceled(AccessBridge_MenuCanceledFP fp);
	__declspec(dllexport) void setMenuDeselected(AccessBridge_MenuDeselectedFP fp);
	__declspec(dllexport) void setMenuSelected(AccessBridge_MenuSelectedFP fp);
	__declspec(dllexport) void setPopupMenuCanceled(AccessBridge_PopupMenuCanceledFP fp);
	__declspec(dllexport) void setPopupMenuWillBecomeInvisible(AccessBridge_PopupMenuWillBecomeInvisibleFP fp);
	__declspec(dllexport) void setPopupMenuWillBecomeVisible(AccessBridge_PopupMenuWillBecomeVisibleFP fp);

	__declspec(dllexport) void setPropertyNameChange(AccessBridge_PropertyNameChangeFP fp);
	__declspec(dllexport) void setPropertyDescriptionChange(AccessBridge_PropertyDescriptionChangeFP fp);
	__declspec(dllexport) void setPropertyStateChange(AccessBridge_PropertyStateChangeFP fp);
	__declspec(dllexport) void setPropertyValueChange(AccessBridge_PropertyValueChangeFP fp);
	__declspec(dllexport) void setPropertySelectionChange(AccessBridge_PropertySelectionChangeFP fp);
	__declspec(dllexport) void setPropertyTextChange(AccessBridge_PropertyTextChangeFP fp);
	__declspec(dllexport) void setPropertyCaretChange(AccessBridge_PropertyCaretChangeFP fp);
	__declspec(dllexport) void setPropertyVisibleDataChange(AccessBridge_PropertyVisibleDataChangeFP fp);
	__declspec(dllexport) void setPropertyChildChange(AccessBridge_PropertyChildChangeFP fp);
	__declspec(dllexport) void setPropertyActiveDescendentChange(AccessBridge_PropertyActiveDescendentChangeFP fp);

	__declspec(dllexport) void setPropertyTableModelChange(AccessBridge_PropertyTableModelChangeFP fp);


    /**
     * General routines
     */
	__declspec(dllexport) void releaseJavaObject(long vmID, Java_Object object);
	__declspec(dllexport) BOOL getVersionInfo(long vmID, AccessBridgeVersionInfo *info);
	__declspec(dllexport) HWND getHWNDFromAccessibleContext(long vmID, JOBJECT64 accesibleContext);

    /**
     * Accessible Context routines
     */
	__declspec(dllexport) BOOL getAccessibleContextAt(long vmID, AccessibleContext acParent,
                                jint x, jint y, AccessibleContext *ac);
	__declspec(dllexport) BOOL getAccessibleContextWithFocus(HWND window, long *vmID, AccessibleContext *ac);
	__declspec(dllexport) BOOL getAccessibleContextInfo(long vmID, AccessibleContext ac, AccessibleContextInfo *info);
	__declspec(dllexport) AccessibleContext getAccessibleChildFromContext(long vmID, AccessibleContext ac, jint index);
	__declspec(dllexport) AccessibleContext getAccessibleParentFromContext(long vmID, AccessibleContext ac);

    /**
     * Accessible Text routines
     */
	__declspec(dllexport) BOOL getAccessibleTextInfo(long vmID, AccessibleText at, AccessibleTextInfo *textInfo, jint x, jint y);
	__declspec(dllexport) BOOL getAccessibleTextItems(long vmID, AccessibleText at, AccessibleTextItemsInfo *textItems, jint index);
	__declspec(dllexport) BOOL getAccessibleTextSelectionInfo(long vmID, AccessibleText at, AccessibleTextSelectionInfo *textSelection);
	__declspec(dllexport) BOOL getAccessibleTextAttributes(long vmID, AccessibleText at, jint index, AccessibleTextAttributesInfo *attributes);
	__declspec(dllexport) BOOL getAccessibleTextRect(long vmID, AccessibleText at, AccessibleTextRectInfo *rectInfo, jint index);
	__declspec(dllexport) BOOL getAccessibleTextLineBounds(long vmID, AccessibleText at, jint index, jint *startIndex, jint *endIndex);
	__declspec(dllexport) BOOL getAccessibleTextRange(long vmID, AccessibleText at, jint start, jint end, wchar_t *text, short len);

    /* begin AccessibleTable routines */
	__declspec(dllexport) BOOL getAccessibleTableInfo(long vmID, AccessibleContext acParent, AccessibleTableInfo *tableInfo);

	__declspec(dllexport) BOOL getAccessibleTableCellInfo(long vmID, AccessibleTable accessibleTable, jint row, jint column,
                                    AccessibleTableCellInfo *tableCellInfo);

	__declspec(dllexport) BOOL getAccessibleTableRowHeader(long vmID, AccessibleContext acParent, AccessibleTableInfo *tableInfo);
	__declspec(dllexport) BOOL getAccessibleTableColumnHeader(long vmID, AccessibleContext acParent, AccessibleTableInfo *tableInfo);

	__declspec(dllexport) AccessibleContext getAccessibleTableRowDescription(long vmID, AccessibleContext acParent, jint row);
	__declspec(dllexport) AccessibleContext getAccessibleTableColumnDescription(long vmID, AccessibleContext acParent, jint column);

	__declspec(dllexport) jint getAccessibleTableRowSelectionCount(long vmID, AccessibleTable table);
	__declspec(dllexport) BOOL isAccessibleTableRowSelected(long vmID, AccessibleTable table, jint row);
	__declspec(dllexport) BOOL getAccessibleTableRowSelections(long vmID, AccessibleTable table, jint count, jint *selections);

	__declspec(dllexport) jint getAccessibleTableColumnSelectionCount(long vmID, AccessibleTable table);
	__declspec(dllexport) BOOL isAccessibleTableColumnSelected(long vmID, AccessibleTable table, jint column);
	__declspec(dllexport) BOOL getAccessibleTableColumnSelections(long vmID, AccessibleTable table, jint count, jint *selections);

	__declspec(dllexport) jint getAccessibleTableRow(long vmID, AccessibleTable table, jint index);
	__declspec(dllexport) jint getAccessibleTableColumn(long vmID, AccessibleTable table, jint index);
	__declspec(dllexport) jint getAccessibleTableIndex(long vmID, AccessibleTable table, jint row, jint column);
    /* end AccessibleTable */

    /* ----- AccessibleRelationSet routines */
	__declspec(dllexport) BOOL getAccessibleRelationSet(long vmID, AccessibleContext accessibleContext,
	                          AccessibleRelationSetInfo *relationSetInfo);
     ...
     */
	__declspec(dllexport) BOOL getAccessibleHypertext(long vmID, AccessibleContext accessibleContext,
                                AccessibleHypertextInfo *hypertextInfo);

    /*
     * Requests that a hyperlink be activated.
     */
	__declspec(dllexport) BOOL activateAccessibleHyperlink(long vmID, AccessibleContext accessibleContext,
                                     AccessibleHyperlink accessibleHyperlink);
     ...
     * Returns -1 on error.
     */
	__declspec(dllexport) jint getAccessibleHyperlinkCount(const long vmID,
                                         const AccessibleHypertext hypertext);
     ...
     */
	__declspec(dllexport) BOOL getAccessibleHypertextExt(const long vmID,
                                   const AccessibleContext accessibleContext,
                                   const jint nStartIndex,
     ...
     * Returns -1 on error.
     */
	__declspec(dllexport) jint getAccessibleHypertextLinkIndex(const long vmID,
                                         const AccessibleHypertext hypertext,
                                         const jint nIndex);
     ...
     * Returns FALSE on error
     */
	__declspec(dllexport) BOOL getAccessibleHyperlink(const long vmID,
                                const AccessibleHypertext hypertext,
                                const jint nIndex, 
     ...
     */
	__declspec(dllexport) BOOL getAccessibleKeyBindings(long vmID, AccessibleContext accessibleContext,
                                  AccessibleKeyBindings *keyBindings);

    /*
     * Returns a list of icons associate with a component.
     */
	__declspec(dllexport) BOOL getAccessibleIcons(long vmID, AccessibleContext accessibleContext,
                            AccessibleIcons *icons);

    /* 
     * Returns a list of actions that a component can perform.
     */
	__declspec(dllexport) jint getAccessibleActions(long vmID, AccessibleContext accessibleContext);
	__declspec(dllexport) BOOL getAccessibleActionItem(jint index, wchar_t* action, jint len);
     ...
     */
	__declspec(dllexport) BOOL doAccessibleActions(long vmID, AccessibleContext accessibleContext,
                             AccessibleActionsToDo *actionsToDo, jint *failure);
     ...
     */
	__declspec(dllexport) BOOL isSameObject(long vmID, JOBJECT64 obj1, JOBJECT64 obj2);
     ...
     */
	__declspec(dllexport) BOOL setTextContents (const long vmID, const AccessibleContext accessibleContext, const wchar_t *text);
     ...
     */
	__declspec(dllexport) AccessibleContext getParentWithRole (const long vmID, const AccessibleContext accessibleContext,
                                         const wchar_t *role);
     ...
     */
	__declspec(dllexport) AccessibleContext getParentWithRoleElseRoot (const long vmID, const AccessibleContext accessibleContext,
                                                 const wchar_t *role);
     ...
     */
	__declspec(dllexport) AccessibleContext getTopLevelObject (const long vmID, const AccessibleContext accessibleContext);
     ...
     * Returns -1 on error.
     */
	__declspec(dllexport) int getObjectDepth (const long vmID, const AccessibleContext accessibleContext);
     ...
     */
	__declspec(dllexport) AccessibleContext getActiveDescendent (const long vmID, const AccessibleContext accessibleContext);

    /**
       /**
       * Accessible Value routines
       */
	__declspec(dllexport) BOOL getCurrentAccessibleValueFromContext(long vmID, AccessibleValue av, wchar_t *value, short len);
	__declspec(dllexport) BOOL getMaximumAccessibleValueFromContext(long vmID, AccessibleValue av, wchar_t *value, short len);
	__declspec(dllexport) BOOL getMinimumAccessibleValueFromContext(long vmID, AccessibleValue av, wchar_t *value, short len);

    /**
     * Accessible Selection routines
     */
	__declspec(dllexport) void addAccessibleSelectionFromContext(long vmID, AccessibleSelection as, int i);
	__declspec(dllexport) void clearAccessibleSelectionFromContext(long vmID, AccessibleSelection as);
	__declspec(dllexport) JOBJECT64 getAccessibleSelectionFromContext(long vmID, AccessibleSelection as, int i);
	__declspec(dllexport) int getAccessibleSelectionCountFromContext(long vmID, AccessibleSelection as);
	__declspec(dllexport) BOOL isAccessibleChildSelectedFromContext(long vmID, AccessibleSelection as, int i);
	__declspec(dllexport) void removeAccessibleSelectionFromContext(long vmID, AccessibleSelection as, int i);
	__declspec(dllexport) void selectAllAccessibleSelectionFromContext(long vmID, AccessibleSelection as);
     ...
     */
	__declspec(dllexport) BOOL getVirtualAccessibleName(const long vmID, const AccessibleContext accessibleContext,
                               wchar_t *name, int len);
     ...
     */
	__declspec(dllexport) BOOL requestFocus(const long vmID, const AccessibleContext accessibleContext);
     ...
     */
	__declspec(dllexport) BOOL selectTextRange(const long vmID, const AccessibleContext accessibleContext, const int startIndex,
                         const int endIndex);
     ...
     */
	__declspec(dllexport) BOOL getTextAttributesInRange(const long vmID, const AccessibleContext accessibleContext,
                                  const int startIndex, const int endIndex,
                                  AccessibleTextAttributesInfo *attributes, short *len);
     ...
     */
	__declspec(dllexport) int getVisibleChildrenCount(const long vmID, const AccessibleContext accessibleContext);
     ...
     * Bug ID 4944762- getVisibleChildren for list-like components needed
     */
	__declspec(dllexport) BOOL getVisibleChildren(const long vmID, const AccessibleContext accessibleContext,
     ...
     */
	__declspec(dllexport) BOOL setCaretPosition(const long vmID, const AccessibleContext accessibleContext,
                          const int position);

    /**
     * Gets the text caret location
     */
	__declspec(dllexport) BOOL getCaretLocation(long vmID, AccessibleContext ac,
                          AccessibleTextRectInfo *rectInfo, jint index);

    /**
     * Gets the number of events waiting to fire
     */
	__declspec(dllexport) int getEventsWaiting();
